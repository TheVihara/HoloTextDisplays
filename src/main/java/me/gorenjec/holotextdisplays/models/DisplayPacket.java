package me.gorenjec.holotextdisplays.models;
...
public class DisplayPacket {
    ...
    public void spawnItemEntity(Player player, int entityId, UUID uuid, Location location, ItemStack item, String text, float viewRange, float yaw, float pitch, Display.BillboardConstraints billboardConstraints) {
        ClientboundAddEntityPacket packet = new ClientboundAddEntityPacket(
                entityId,
                uuid,
                location.getX(),
